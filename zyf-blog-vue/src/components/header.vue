...
<div class="">
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg04.jpg)'}">
		<div class="scene">
...
.h-information {
	...
	font-size: 16px;
	opacity: 0.98;
	background: rgba(230, 244, 249, 0.5);
	border-radius: 30px;
	z-index: 1;
